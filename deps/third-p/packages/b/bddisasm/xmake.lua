package("bddisasm")
    ...
    add_versions("v1.37.0", "d16f1d8ba346a301ed32d28b6384472f18c1992e")
    ...
    on_install("!wasm", function (package)
        ...
        table.insert(configs, "-DBDD_INCLUDE_ISAGENERATOR" .. (package:version():lt("2.2.0") and "_X86=" or "") .. (package:config("isagenerator") and "ON" or "OFF"))
        ...
        os.cp(package:installdir() .. "/include/bddisasm/*.h", package:installdir() .. "/include")
